...
const portraitHolder = {
  image1: {
    imageLazy: "Portrait photography/portrait-1-lazy.jpg",
  ...
  image2: {
    imageLazy: "Portrait photography/portrait-2-lazy.jpg",
  ...
  image3: {
    imageLazy: "Portrait photography/portrait-3-lazy.jpg",
  ...
  image4: {
    imageLazy: "Portrait photography/portrait-4-lazy.jpg",
  ...
  image5: {
    imageLazy: "Portrait photography/portrait-5-lazy.jpg",
  ...
  image6: {
    imageLazy: "Portrait photography/portrait-6-lazy.jpg",
  ...
  image7: {
    imageLazy: "Portrait photography/portrait-7-lazy.jpg",
  ...
  image8: {
    imageLazy: "Portrait photography/portrait-8-lazy.jpg",
  ...
  image9: {
    imageLazy: "Portrait photography/portrait-9-lazy.jpg",
  ...
  for (let i = 0; i < maxImagesPerLoad; i++) {
    ...
    html += `
                <div class="image-holder">
                  <img
                    class="gallery-image lazy-img"
                    src="${images[i].imageLazy}"
                    data-src="${images[i].imageUrl}"
                    alt="${images[i].altTag}"
                  />
                </div>
`;
